...
use App\Filament\Resources\GameSessions\RelationManagers\FinalScoresRelationManager;
...
class GameSessionResource extends Resource
{
    ...
    protected static string|\UnitEnum|null $navigationGroup = 'Game Sessions & Activity';
    ...
    public static function getRelations(): array
    {
        return [
            ...
            FinalScoresRelationManager::class,
        ];
    }
