...
use App\Filament\Resources\QuizQuestions\RelationManagers\AnswerVariantsRelationManager;
use App\Filament\Resources\QuizQuestions\RelationManagers\MultipleChoiceOptionsRelationManager;
use App\Filament\Resources\QuizQuestions\RelationManagers\PlaylistItemsRelationManager;
use App\Filament\Resources\QuizQuestions\RelationManagers\SessionRoundsRelationManager;
...
class QuizQuestionResource extends Resource
{
    ...
    protected static string|\UnitEnum|null $navigationGroup = 'Quiz Structure & Questions';
    ...
    {
        return [
            AnswerVariantsRelationManager::class,
            MultipleChoiceOptionsRelationManager::class,
            PlaylistItemsRelationManager::class,
            SessionRoundsRelationManager::class,
        ];
    }
