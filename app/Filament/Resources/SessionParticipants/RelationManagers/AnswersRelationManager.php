...
namespace App\Filament\Resources\SessionParticipants\RelationManagers;
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('round.question.track.title')
                    ->label('Track')
                    ->searchable()
                    ->sortable()
                    ->toggleable(),

                TextColumn::make('round.question.track.artist_name')
                    ->label('Artist')
                    ->searchable()
                    ->sortable()
                    ->toggleable(),

                TextColumn::make('round.question.prompt_text')
                    ->label('Question')
                    ->searchable()
                    ->sortable()
                    ->toggleable(),
