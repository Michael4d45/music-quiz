            ...
            <div className="bg-card overflow-hidden rounded-lg shadow">
                <table className="divide-secondary min-w-full divide-y">
                    <thead className="bg-secondary-bg">
                        <tr>
                            <th className="text-muted px-6 py-3 text-center text-xs font-medium tracking-wider uppercase">
                                Rank
                            </th>
                            ...
                            <tr key={player.id}>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="flex items-center justify-center">
                                        <span
                                            className={`inline-flex h-8 w-8 items-start justify-center rounded-full pt-[0.155rem] pr-[0.01rem] font-semibold ${
                                                index === 0
