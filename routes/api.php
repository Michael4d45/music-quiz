...
Route::middleware(['web', 'auth'])->group(function (): void {
    Route::get('game-sessions/room/{roomCode}', ShowGameSessionByRoomCode::class)
        ->where('roomCode', '[A-Za-z0-9]{6}');
    Route::post('game-sessions/join', JoinGameSession::class);
    Route::delete('game-sessions/{gameSession}/leave', LeaveGameSession::class)
...
Route::middleware(['web', 'registered'])->group(function (): void {
    ...
    Route::patch('my/playlists/{playlist}', UpdatePlaylist::class)->whereUuid('playlist');
    Route::delete('my/playlists/{playlist}', DestroyPlaylist::class)->whereUuid('playlist');
    Route::get('my/playlists/{playlist}/items', ListPlaylistItems::class)->whereUuid('playlist');
    Route::post('my/playlists/{playlist}/items', AddPlaylistItem::class)->whereUuid('playlist');
    Route::delete('my/playlists/{playlist}/items/{playlistItem}', RemovePlaylistItem::class)
        ->whereUuid('playlist')
    ...
    Route::patch('my/quiz-questions/{quizQuestion}', UpdateQuizQuestion::class)->whereUuid(
        'quizQuestion',
    );
    Route::delete('my/quiz-questions/{quizQuestion}', DestroyQuizQuestion::class)->whereUuid(
        'quizQuestion',
    );

    Route::get('my/music-tracks', ListMyMusicTracks::class);
    Route::post('my/music-tracks', CreateMusicTrack::class);
    Route::patch('my/music-tracks/{musicTrack}', UpdateMusicTrack::class)->whereUuid('musicTrack');
    Route::delete('my/music-tracks/{musicTrack}', DestroyMusicTrack::class)->whereUuid(
        'musicTrack',
    );

    Route::get('my/game-sessions', ListMyGameSessions::class);
    Route::post('my/game-sessions', CreateGameSession::class);
    Route::patch('my/game-sessions/{gameSession}', UpdateGameSession::class)->whereUuid(
        'gameSession',
    );
